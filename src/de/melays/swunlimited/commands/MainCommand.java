...
import de.melays.swunlimited.teams.Color;
...
public class MainCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String alias, String[] args) {
		...
		if (args.length == 0) {
			...
			if (!main.getMessageFetcher().checkPermission(sender, "swunlimited.reload"))return true;
			main.reloadAll();
			...
			if (!main.getMessageFetcher().checkPermission(sender, "swunlimited.setup"))return true;
			String c = "";
			...
			if (!main.getMessageFetcher().checkPermission(sender, "swunlimited.setup"))return true;
			if (args.length == 1) {
				sender.sendMessage(main.getMessageFetcher().getMessage("command_usage", true).replaceAll("%command%", "/sw worldtp <game , presets , world>"));
				return true;
			}
			...
			sender.sendMessage(main.getMessageFetcher().getMessage("help.unknown", true).replaceAll("%help%", "/sw help"));
		}
